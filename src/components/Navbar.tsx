...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-[2px] z-10 bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-lg w-[100%]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex items-center">
            <ShoppingBag className="h-8 w-8" />
            <h1 className="ml-2 text-xl font-bold">ShopHub</h1>
          </div>
      ...
      <div className={`md:hidden ${isOpen ? 'block' : 'hidden'}`}>
        <div className="px-2 pt-4 pb-3 space-y-1 bg-gradient-to-r from-emerald-700 to-teal-700 mt-[5rem]">
